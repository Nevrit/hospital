                ...
                <form action="submit.php" method="POST">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="last-name" name="last-name" required placeholder="Entrez votre nom">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="first-name" class="form-label">Prénom*</label>
                            <input type="text" class="form-control" id="first-name" name="first-name" required placeholder="Entrez votre prénom">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select" id="gender" name="sexe" required>
                                <option value="" selected disabled>Quel est votre sexe ?</option>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="tel" class="form-control" id="contact" required name="telephone" required 
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="email" class="form-control" id="email" required name="email" placeholder="Entrez votre email">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="allergie" class="form-label">Allergie*</label>
                            <input type="tel" class="form-control" required id="allergie" name="allergie" 
                            placeholder="Citez vos ce a quoi vous êtes allergique">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
